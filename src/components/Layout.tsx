...
export default function Layout({ children }: LayoutProps) {
  ...
  const menuItems = [
    { name: 'Dashboard Utama', icon: Home, to: '/' },
    { name: 'Pengelolaan Kasus TGR', icon: Shield, to: '/pengelolaan-kasus-tgr' },
    { name: 'Pencatatan Kerugian', icon: FileText, to: '/pencatatan-kerugian' },
